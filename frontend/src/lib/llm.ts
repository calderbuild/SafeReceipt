...
KNOWN ADDRESSES (Monad testnet, chain 10143 - use these when the user mentions these names):
Tokens:
- DemoUSD (dUSD, 6 decimals): 0x5a3b52260C44cD1Ec70C7157131bC15913Cd835f
...
1. For token approvals (ERC20 approve):
   ...
   - If user mentions a known name (like "DemoUSD", "Permit2"), use the address from KNOWN ADDRESSES above
   - Amount should be in wei (multiply by 10^decimals, DemoUSD=6, others=18)
